...
![principle1](./readme_pic/principle1.png)
如果是一个16位的加法器，可以按照如下方法排列，称为线性进位选择加法器：
![principle2](./readme_pic/principle2.png)
...
![principle3](./readme_pic/principle3.png)
...
![principle6](./readme_pic/principle6.png)
...
![principle7](./readme_pic/principle7.png)
以下就是设计好的结构图：
![principle8](./readme_pic/principle8.png)
...
![design1](./readme_pic/design1.png)
...
![wallace1](./readme_pic/wallace1.png)![wallace2](./readme_pic/wallace2.png)
...
![systemdesign](./readme_pic/systemdesign.png)
